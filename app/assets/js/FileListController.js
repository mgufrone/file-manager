angular.module('app', ['angularFileUpload'])
    ...
    .controller('FileListController', ['$scope','$fileUploader','$http',function ($scope, $fileUploader, $http) {
        'use strict';
        var files = $scope.files = [];
        var type = $scope.type = 'grid';
        $scope.getFiles = function(){
        	$http.get(base.path+'files.json').success(function(data){
